<?php
   ...
   if(isset($_POST['submit'])){
       ...
       $stmt = $conn->prepare("INSERT INTO donorss (full_name,age,mobile,email,gender,blood_nmae,postarea_name,address,emergency_contact,emergency_contact_relationship,emergency_mobile,last_onated_date) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
